...
\hypersetup{
  ...
  pdfkeywords={NHTS, R, XGBoost, SVM, Random Forest, Neural
...
\Keywords{NHTS, R, XGBoost, SVM, Random Forest, Neural Network, Logistic
Regression}
\Plainkeywords{NHTS, R, XGBoost, SVM, Random Forest, Neural
Network, Logistic Regression}
