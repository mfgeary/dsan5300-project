#' Clean National Household Travel Survey Names
#' 
#' This script is designed to clean the feature names for the
#' National Household Travel Survey (NHTS) data. The raw data
#' is read in and the feature names are cleaned to be more interpretable,
#' using the NHTS data dictionary and a custom mapping.
#' 
...
# Save the cleaned data to data/clean/clean-names as parquet files
household |> write_parquet("data/clean/clean-names/household.parquet")
household |> write_csv("data/clean/clean-names/household.csv")
person |> write_parquet("data/clean/clean-names/person.parquet")
person |> write_csv("data/clean/clean-names/person.csv")
trip |> write_parquet("data/clean/clean-names/trip.parquet")
trip |> write_csv("data/clean/clean-names/trip.csv")
vehicle |> write_parquet("data/clean/clean-names/vehicle.parquet")
vehicle |> write_csv("data/clean/clean-names/vehicle.csv")
long_distance |> write_parquet("data/clean/clean-names/long_distance.parquet")
long_distance |> write_csv("data/clean/clean-names/long_distance.csv")